...
func main() {
	...
	rootCmd.PersistentFlags().BoolVar(&config.postProcessing1, "post1", false, "Postprocessing method 1: If the translation has more line breaks than the original text, discard the line break and the content that follows it.")
